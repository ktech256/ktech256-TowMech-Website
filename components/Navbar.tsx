...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white md:border-white/10 md:bg-ink/70 md:backdrop-blur-xl">
      ...
      <nav className="border-t border-slate-200 px-4 py-2 md:hidden">
        <div className="mx-auto flex max-w-6xl items-center gap-3 overflow-x-auto pb-1">
          {links.map((link) => {
            const active = pathname === link.href;
